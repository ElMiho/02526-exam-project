...
yinterp_wood = wood_composite[0]*np.interp(xinterp, x_val_carbon, y_val_carbon) \
    + wood_composite[1]*np.interp(xinterp,x_val_hydrogen,y_val_hydrogen) \
    + wood_composite[2]*np.interp(xinterp,x_val_oxygen,y_val_oxygen)
