...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{\small Absolute difference between the attenuation coefficients for bismuth and iron. Data is calculated using linear interpolation - see appendix ???.}
        \label{fig:diff-attenuation-coef-bismuth-iron}
    \end{subfigure}
    \caption{Note that in both of these images that they are only plotted in the log interval for commercial X-Ray (10 keV - 200 keV).}
